...
public class Search
{
    // mergeSort(): performs a mergeSort on a String array
    ...
    // merge(): merges the sorted array into one
    // pre: array is not empty
    ...
    // main(): first counts the line numbers, 
    // then prints where an element is found
